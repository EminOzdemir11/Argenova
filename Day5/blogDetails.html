...
<header>
    <div class="header">
        ...
        <div id="ana-img" style="height: 400px; text-align: center;">
            <h1 style="transform: translateY(150%);">Servo Project Joins The Linux <br> Foundation Fold Desco</h1>
            <h5 style="transform: translateY(700%);">Home / Blog / It Services / Servo Project Joins The Linux Foundation Fold Desco</h5>
        </div>
    </div>
</header>
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div style="background-color: white; border-radius: 5px; margin: 20px; padding-left: 10px; padding-right: 10px;">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#">
                                <img style="border-radius: 5px; margin: 10px;" src="https://rstheme.com/products/html/braintech/assets/images/blog/inner/5.jpg" width="665" height="480">
                            </a>
                        </div>
                            ...
                            <div class="blog-content">
                                ...
                                <div class="blog-meta">
                                    <ul class="btm-cate">
                                        ...
                                        <li style="display: inline;">
                                                <i style="color: blue;" class="fa fa-book"></i>
                                                <a style="text-decoration: none; color: rgb(56, 53, 53); font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;" href="#">Strategy</a>
                                        </li>
                                        <li style="display: inline; color: blue;"><i class="fa fa-comments-o"></i> 1</li>
                                    </ul>
                                </div>
                                <div class="blog-desc">   
    ...
    <div class="container">
        <div style="margin-left: 20px; margin-right: 10px;" class="row">
            <div style="background-color: white; border-radius: 0px 10px 10px 0px; padding-top: 10px;" class="col-md-7">
                <div style="margin-left: 20px; margin-right: 10px; width: 150%;" class="row">
                    <div style="border-radius: 10px 0px 0px 10px; padding-left: 10px;" class="col-md-1">
        
                    </div>
                    <div style="border-radius: 0px 10px 10px 0px;padding-left: 10px; padding-top: 10px;" class="col-md-6">
                        <br>
                        <blockquote style="font-style: italic;">We can easily manage if we will only take, each day, the burden appointed to it. But the load will be too heavy for us if we carry yesterday’s burden over again today, and then add the burden of the morrow before we are required to bear it. <br><br>
                           <span style="padding-left: 30px;">Robert Calibo</span>
                        </blockquote>
                    </div>
                    <div class="col-md-5">
                ...
                <br><br>   
                <h3 style="padding-left: 10px;"><b>Digital technology on the cutting edge</b></h3>
                <br>
                <ul style="margin-left: 30px; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
            ...
            <div class="col-md-7">
                <div style="background-color: white; border-radius: 5px; margin: 20px; padding-left: 10px; padding-right: 10px;">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#">
                                <img style="border-radius: 5px; margin: 10px;" src="https://rstheme.com/products/html/braintech/assets/images/blog/inner/6.jpg" width="665" height="480">
                            </a>
                        </div>
                        <div style="padding-left: 40px;" class="col-md-12">
                            <div class="blog-content">
                ...
                <br>
                <h4 style="margin-left: 40px;">1 comment on “Servo Project Joins The Linux Foundation Desco”</h4><br>
                <div class="row">
                    <div class="col-md-1"></div>
                    <div class="col-md-2">
                        <a href="#">
                            <img style="border-radius: 50%;" src="https://rstheme.com/products/html/braintech/assets/images/rstheme.png" alt="">
                        </a>
                    </div>
                    <div class="col-md-9">
                        <h6><b>Admin</b></h6>
                        <a style="text-decoration: none; color: rgb(109, 105, 105); font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;" href="#">December 3, 2020 at 8:30 am</a>
                        <p style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est</p>
                        <div>
                            <button id="button-small" type="submit" class="btn btn-sm">Reply</button>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <h4 style="margin-left: 18px;">Leave a Reply</h4><br>
                <a style="margin-left: 18px; text-decoration: none; color: rgb(92, 90, 90); font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;" href="#">Your email address will not be published. Required fields are marked *</a>
                <form id="form1" class="m-3">
                    <div class="col-md-12">
                        ...
                        <div>
                            <button id="button" type="submit" class="btn btn-sm">Post Comment</button>
                        </div>
                    </div>
                </form>
            </div>
